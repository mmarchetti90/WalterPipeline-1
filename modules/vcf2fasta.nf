process ConvertVCF {
  ...
  bcftools consensus --include "(TYPE!='indel' & INFO/DP >= ${params.depth_threshold}) & (QUAL >= ${params.qual_threshold} | GT == '0')" --mask ${params.resources_dir}/${params.bed_path} --fasta-ref ${reference} --absent 'N' --missing 'N' ${vcf} | \
